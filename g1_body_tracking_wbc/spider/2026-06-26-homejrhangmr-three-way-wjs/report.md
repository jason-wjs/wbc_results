...
- Raw `.npz` rollout artifacts normally stay outside `wbc_results`; this package has a user-approved exception for the sweetpoint and n8192 rollout files only. MPC command npz files remain externally indexed.
